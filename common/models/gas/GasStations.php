...
/**
 * This is the model class for table "{{%gas_stations}}".
 *
 ...
 */
class GasStations extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['gasId'], 'string', 'max' => 30],
            [['gasName', 'gasLogoBig', 'gasLogoSmall', 'gasAddress'], 'string', 'max' => 250],
