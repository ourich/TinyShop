...
/**
 * This is the model class for table "{{%oil_order}}".
 *
 ...
 */
class OilOrder extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['status', 'from', 'gunNo', 'oilNo', 'orderStatusName', 'couponId', 'created_at'], 'integer'],
            [['amountPay', 'amountGun', 'amountDiscounts', 'couponMoney'], 'number'],
            [['orderId'], 'string', 'max' => 60],
            [['paySn', 'orderSource', 'qrCode4PetroChina'], 'string', 'max' => 50],
            [['phone', 'litre'], 'string', 'max' => 20],
            [['orderTime', 'payTime', 'refundTime', 'couponCode'], 'string', 'max' => 30],
            [['gasName'], 'string', 'max' => 150],
            [['province', 'city', 'county', 'priceUnit', 'priceOfficial', 'priceGun'], 'string', 'max' => 15],
